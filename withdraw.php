                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="header">
                                    ...
                                    <p class="category">EXPIRED at <?php echo "$value[ExpiredDate]"; ?> </p>
                                </div>
                                <div class="content">
                                    <div>
                                    	
                                        <h2 class="text-info">OTP Code: <?php echo "$value[OTPCode]"; ?></h2>
                                        <h3 class="text-success">IDR <?php echo "$value[Amount]"; ?></h3>
                                    </div>
